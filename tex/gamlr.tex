...
\begin{tabular}{l*{6}{c}|r}
 & lasso & GL $\gamma=2$ & GL $\gamma=10$ & marginal AL & sparsenet  & SCAD & \\
\cline{1-7}
CV.1se & 4.4 & 4.3 & 4.8 & 4.3 & & &\\
CV.min & 4.1 & {\bf 4} & 4.3 & 4.1 & {\bf 4} & 4.3 & $\mr{sd}(\bm{\mu})/\sigma=2$ \\
AICc & 4.3 & 4.1 & 4.1 & 4.2 & & & $\rho=0$ \\
AIC & 5 & 5.2 & 5.2 & 4.1 & & & $C_p$ mse = 3.5 \\
BIC & 5.6 & 5.1 & 5.7 & 4.9 & & & \\
 \hline 
CV.1se & 3.1 & 3 & 3.4 & 3.1 & & &\\
CV.min & 2.9 & {\bf 2.8} & 3 & 3 & {\bf 2.8} & 3.1 & $\mr{sd}(\bm{\mu})/\sigma=2$ \\
AICc & 3 & {\bf 2.8} & 2.9 & 3 & & & $\rho=0.5$ \\
AIC & 3.4 & 3.5 & 3.5 & 2.9 & & & $C_p$ mse = 2.4 \\
BIC & 4.4 & 3.7 & 4.1 & 3.8 & & & \\
 \hline 
CV.1se & 2.4 & 2.4 & 2.6 & 2.6 & & &\\
CV.min & 2.3 & {\bf 2.2} & 2.3 & 2.4 & {\bf 2.2} & 2.6 & $\mr{sd}(\bm{\mu})/\sigma=2$ \\
AICc & 2.4 & {\bf 2.2} & 2.3 & 2.5 & & & $\rho=0.9$ \\
AIC & 2.6 & 2.7 & 2.7 & 2.4 & & & $C_p$ mse = 1.9 \\
BIC & 3.5 & 3 & 3.3 & 3.2 & & & \\
 \hline 
CV.1se & 17 & 16.9 & 18 & 15.6 & & &\\
CV.min & 15.6 & 15.6 & 16.5 & 15.7 & 15.6 & 15.6 & $\mr{sd}(\bm{\mu})/\sigma=1$ \\
AICc & 15.8 & {\bf 15.5} & 15.9 & 15.6 & & & $\rho=0$ \\
AIC & 21.3 & 22.2 & 22.2 & 17 & & & $C_p$ mse = 13.8 \\
BIC & 20.8 & 19.2 & 23.4 & 17.7 & & & \\
 \hline 
CV.1se & 12 & 11.7 & 12.7 & 11.1 & & &\\
CV.min & 10.9 & 10.8 & 11.5 & 11 & 10.8 & 11.1 & $\mr{sd}(\bm{\mu})/\sigma=1$ \\
AICc & 11.1 & {\bf 10.7} & 10.8 & 11 & & & $\rho=0.5$ \\
AIC & 14.4 & 14.9 & 14.9 & 11.8 & & & $C_p$ mse = 9.2 \\
BIC & 15.8 & 14.4 & 16.1 & 13.4 & & & \\
 \hline 
CV.1se & 9.4 & 9.2 & 10.1 & 9.1 & & &\\
CV.min & 8.6 & {\bf 8.5} & 9 & 8.8 & {\bf 8.5} & 9.1 & $\mr{sd}(\bm{\mu})/\sigma=1$ \\
AICc & 8.8 & {\bf 8.5} & {\bf 8.5} & 8.8 & & & $\rho=0.9$ \\
AIC & 11.2 & 11.6 & 11.6 & 9.1 & & & $C_p$ mse = 7.3 \\
BIC & 12.7 & 12.1 & 12.9 & 11.4 & & & \\
 \hline 
CV.1se & 60.9 & 61.2 & 61.3 & 57.8 & & &\\
CV.min & 57.8 & 59.8 & 60.6 & 60.5 & 57.9 & 57.8 & $\mr{sd}(\bm{\mu})/\sigma=0.5$ \\
AICc & {\bf 57.6} & 60 & 61.4 & 59 & & & $\rho=0$ \\
AIC & 88.4 & 92.5 & 92.5 & 73.2 & & & $C_p$ mse = 53.5 \\
BIC & 61.3 & 61.3 & 61.3 & 60.6 & & & \\
 \hline 
CV.1se & 41.1 & 41.2 & 41.2 & 39.8 & & &\\
CV.min & 39.9 & 40.7 & 41 & 41.3 & 39.9 & 39.8 & $\mr{sd}(\bm{\mu})/\sigma=0.5$ \\
AICc & {\bf 39.6} & 40.5 & 41.3 & 40.5 & & & $\rho=0.5$ \\
AIC & 59.4 & 61.9 & 61.9 & 49.9 & & & $C_p$ mse = 35.9 \\
BIC & 41.2 & 41.2 & 41.2 & 41 & & & \\
 \hline 
CV.1se & 32.6 & 32.6 & 32.6 & 31.8 & & &\\
CV.min & 31.8 & 32.3 & 32.5 & 32.4 & 31.8 & 31.8 & $\mr{sd}(\bm{\mu})/\sigma=0.5$ \\
