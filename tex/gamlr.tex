...
\frac{\|\bm{f}_S-\bm{f}\|^2}{n} +  \frac{3n\lambda^2 (1+c_S)^2 s}{4\phi^2(2(1+c_S), s)}
\end{equation} 
...
If the RHS above is less than or equal to $2\|\bm{f}_S-\bm{f}\|^2 $ then we are done.  Otherwise,
\begin{align*}
\|\bm{\hat y}-\bm{f}\|^2 + \frac{n\lambda}{2}|\bs{\hat\beta}_{S^c}| & <
n\lambda \sqrt{s}\left(1+c_S\right)\|\bs{\hat\beta}_S - \bs{\beta}_S\|
\end{align*}
