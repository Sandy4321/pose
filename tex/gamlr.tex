...
\caption{ \label{nhlic} Hockey example AICc and BIC surfaces, rising from white to black.
}
\end{center}
\end{figure}
...
\multicolumn{1}{c}{} & \multicolumn{3}{l}{\large \it ~~~lasso} & \multicolumn{3}{l}{\large \it ~~~$\gamma=1$} &  \multicolumn{3}{l}{\large \it ~~~$\gamma=10$}\\
...
Palat and Tyler Toffoli both played their first (near) full seasons in the NHL
