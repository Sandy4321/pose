...
\begin{table}
{\it MSE with $\rho=0$, $s2n=1$}
\small\sgl
\begin{center}
\begin{tabular}{l*{6}{c}|r}
 & lasso & GL $\gamma=2$ & GL $\gamma=10$ & marginal AL & sparsenet  & SCAD & $C_p$~ 7.3 \\
\cline{1-7}
cv1se & 9.4 & 9.2 & 10.1 & 9.1 & & & \\
cvmin & 8.6 & 8.5 & 9.0 & 8.8 & 8.5 & 9.1 & \\
aicc & 8.8 & 8.5 & 8.5 & 8.8 & & &  \\
aic & 11.2 & 11.6 & 11.6 & 9.1 & & & \\
