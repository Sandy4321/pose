...
application of diminishing bias estimators.  Big Data application of such
tools nearly always leads to a version of weighted $L_1$ regularization.  Our
new approach learns from the literature to provide a much more practically
