...
\vskip .25cm\footnotesize
\noindent{\bf  Prediction MSE }
\begin{itemize}
\vspace{-.1cm}
  \setlength\itemsep{0em}
\item[] n=1000, sparse simulation model: tables 4-11
\item[] n=1000, dense simulation model: tables 12-19
\item[] n=100, sparse simulation model: tables 20-27 
\item[] n=100, dense simulation model: tables 28-35
\end{itemize}
\noindent{\bf  Estimation MSE }
\begin{itemize}
\vspace{-.1cm}
  \setlength\itemsep{0em}
\item[] n=1000, sparse simulation model: tables 36-43
\item[] n=1000, dense simulation model: tables 44-51
\item[] n=100, sparse simulation model: tables 52-59 
\item[] n=100, dense simulation model: tables 60-67
\end{itemize}

\noindent{\bf  Fitted Model Dimension }
\begin{itemize}
\vspace{-.1cm}
  \setlength\itemsep{0em}
\item[] n=1000, sparse simulation model: tables 68-75
\item[] n=1000, dense simulation model: tables 76-83
\item[] n=100, sparse simulation model: tables 84-91 
\item[] n=100, dense simulation model: tables 92-99
\end{itemize}

\noindent{\bf  Sensitivity and FDR }
\begin{itemize}
\vspace{-.1cm}
  \setlength\itemsep{0em}
\item[] n=1000, sparse simulation model: tables 100-107
\item[] n=1000, dense simulation model: tables 108-115
\item[] n=100, sparse simulation model: tables 116-123
\item[] n=100, dense simulation model: tables 124-131
\end{itemize}
