...
\cite{buhlmann_statistics_2011}, and we note that many of their bounds on
estimation error for weighted-$\ell_1$ penalization rely upon weights derived
from model fits at smaller $\lambda$ than is used in the final esimation --
i.e., the opposite of GL and POSE, where weights are derived from fits at larger
$\lambda$. However, we do consider estimation error in our simulation study
