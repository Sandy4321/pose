...
This is different from the setup that is more familiar to statisticians, where
the oracle comparator is likelihood maximization on the some assumed true support.
